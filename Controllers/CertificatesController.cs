    ...
    ICertificateService certificateService) : ControllerBase
{
    ...
    [EndpointDescription("Returns 404 if the student does not exist. Returns 409 if the student is not enrolled in the course or a certificate already exists.")]
